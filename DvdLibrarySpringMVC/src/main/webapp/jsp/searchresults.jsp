        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <form class="row form-group" action="${pageContext.request.contextPath}/searchDvds" method="GET">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="searchTerm"  name="searchTerm" class="form-control" placeholder="${placeholder}" required="required">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="container text-center">
                ...
                <table id="dvdTable" class="table table-hover">
                    ...
                    <c:forEach var="currentDvd" items="${dvdSearchResult}">
                        <tr>
                            ...
                            <td><a href="${pageContext.request.contextPath}/delete?dvdId=${currentDvd.dvdId}">Delete</a> |
                                <a href="${pageContext.request.contextPath}/editPage?dvdId=${currentDvd.dvdId}" onClick="return confirm('Are you sure you want to delete?');">Edit</a></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
