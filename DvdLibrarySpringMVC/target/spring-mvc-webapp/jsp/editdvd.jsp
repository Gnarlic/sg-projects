...
<html>
    ...
    <body>
        <div class="container">
            <h1 class="text-center">Edit DVD</h1>
            <br/>
            <div class="row">
                <div class="col-md-2">
                ...
                <div>
                    <sf:form class="form-horizontal" role="form" modelAttribute="dvd"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="director" path="director" name="newDirector" placeholder="${dvd.director}"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="number" class="form-control" id="release-year"
                                          path="date" placeholder="${dvd.date}" required="required"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="studio" class="col-md-2 control-label">Studio:</label>
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="studio" path="studio" placeholder="${dvd.studio}"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="user-rating" path="userRating" name="newRating" placeholder="${dvd.userRating}"/>
                            </div>
                        </div>
                        <div class="form-group row">
