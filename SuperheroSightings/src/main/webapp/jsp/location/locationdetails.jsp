...
<html>
    ...
    <body>
        ...
        <div class="container text-center">
            <h2 class="text-center pb-2">${location.locationName}</h3>
            <a href="${pageContext.request.contextPath}/location/editlocation?locationId=${location.locationId}"><button class="btn btn-default">Edit Location</button></a>
        </div>
        <div class="container">
            ...
            <div>
                <h4>Address:</h4>
                ${location.locationAddress} ${location.locationStreetName}, ${location.locationCityName}, ${location.locationStateName} ${location.locationZipCode}
            </div>
            <div>
                <div>
                <h4>Coordinates:</h4>
