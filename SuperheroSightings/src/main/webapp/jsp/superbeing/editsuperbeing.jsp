            ...
            <div class="row">
                ...
                <div class="col-md-6 pr-1">
                    ...
                    <div class="container text-center pb-2">
                        <h4>Edit Superbeing</h4>
                    </div>
        <div class="container" id="editsuperbeing">
            <div>
                <sf:form class="form-horizontal" role="form" modelAttribute="superbeing"
                         method="POST" action="editSuperbeing">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <sf:input type="text" class="form-control" id="superbeing-name" name="superbeingName"
                                      path="superbeingName" placeholder="${superbeing.superbeingName}" required="required"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="superbeing-description" class="col-md-2 control-label">Description:</label>
                        <div class="col-md-4">
                            <sf:input type="text" class="form-control" id="superbeing-description"
                                      path="superbeingDescription" placeholder="${superbeing.superbeingDescription}"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <sf:input type="text" class="form-control" id="superbeing-powers"
                                      path="superbeingPower" placeholder="${superbeing.superbeingPower}"/>
                        </div>
                    </div>
                    <div class="form-group row">
