    ...
    <body>
        ...
        <div class="container">
            <div class="text-center pb-2">
                <a href="${pageContext.request.contextPath}/superbeing/addSuper"><button class="btn btn-default">Add Superbeing</button></a>
            </div>
        </div>
        <div class="container">
            <div class="">
                <table class="table table-hover">
                    <tr>
                        <th colspan="3" class="text-center bg-info text-white">Superbeing List</th>
                    </tr>
                    ...
                    <c:forEach var="currentSighting" items="${superbeing}"> 
                        <tr>
                            <td class="border-bottom border-info"><a href="${pageContext.request.contextPath}/superbeing/superbeingdetails?superbeingId=${currentSighting.superbeingId}"><c:out value="${currentSighting.superbeingName}"/></td></a>
                            <td class="border-bottom border-info"><c:out value="${currentSighting.heroOrVillain}"/></td>
                            <td class="border-bottom border-info"><a href="${pageContext.request.contextPath}/superbeing/editSuper?superbeingId=${currentSighting.superbeingId}">Edit</a> | 
                                <sec:authorize access="hasRole('ROLE_ADMIN')"><a href="${pageContext.request.contextPath}/superbeing/deleteSuper?superbeingId=${currentSighting.superbeingId}">Delete</a></sec:authorize>
                        </tr>
                    </c:forEach>
                </table>
