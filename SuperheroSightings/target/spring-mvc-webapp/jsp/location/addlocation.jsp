                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="locatin-name" name="locationName"
                                          path="locationName" placeholder="Location Name" required="required"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="textarea" class="form-control" id="location-description"
                                          path="locationDescription" placeholder="Description"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="location-address"
                                          path="locationAddress" placeholder="Address"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="location-street"
                                          path="locationStreetName" placeholder="Street"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="location-city"
                                          path="locationCityName" placeholder="City"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="location-state"
                                          path="locationStateName" placeholder="State"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="location-zipcode"
                                          path="locationZipCode" placeholder="Zipcode"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="location-latitude"
                                          path="latitude" placeholder="00.0"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <sf:input type="text" class="form-control" id="location-longitude"
                                          path="longitude" placeholder="00.0"/>
                            </div>
                        </div>
