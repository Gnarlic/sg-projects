    ...
    <body>
        ...
        <div class="container">
            <div class="text-center pb-2">
                <a href="${pageContext.request.contextPath}/location/addlocation"><button class="btn btn-default">Add Location</button></a>
            </div>
        </div>
        <div class="container">
            <div class="">
                ...
                <table class="table table-hover">
                    <tr>
                        <th colspan="3" class="text-center bg-info text-white">Location List</th>
                    </tr>
                    ...
                    <c:forEach var="currentLocation" items="${locations}"> 
                        <tr>
                            <td class="border-bottom border-info"><a href="${pageContext.request.contextPath}/location/locationdetails?locationId=${currentLocation.locationId}"><c:out value="${currentLocation.locationName}"/></td></a>
                            <td class="border-bottom border-info"><c:out value="${currentLocation.locationCityName}"/>, <c:out value="${currentLocation.locationStateName}"/></td>
                            <td class="border-bottom border-info"><a href="${pageContext.request.contextPath}/location/editlocation?locationId=${currentLocation.locationId}">Edit</a> | 
                                <sec:authorize access="hasRole('ROLE_ADMIN')"><a href="${pageContext.request.contextPath}/location/deleteLocation?locationId=${currentLocation.locationId}">Delete</a></sec:authorize>
                        </tr>
                    </c:forEach>
                </table>
            </div>
