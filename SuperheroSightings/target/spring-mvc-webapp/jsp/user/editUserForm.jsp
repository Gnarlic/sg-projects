    ...
    <body>
        ...
        <div class="container">
                ...
                <div class="form-group row">
                    <label for="username" class="col-md-2 control-label">Edit Username: </label>
                    <div class="col-md-4">
                        <sf:input path="username" type="text" class="form-control" id="username" placeholder="${user.username}"
                               name="username"/>
                    </div>
                </div>
                <div class="form-group row">

                    <label for="password" class="col-md-2 control-label">Enter New Password: </label>
                    <div class="col-md-4">
                        <sf:input type="password" id="password" path="password" class="form-control" placeholder="Password" autocomplete="new-password"
                               name="password"/>
                    </div>
                </div>
                <div class="form-group row">
        ...
        <script src="${pageContext.request.contextPath}/js/autofill.js"></script>
    </body>
</html>
