...
public class DoOrDoNot {
    ...
    public static void main(String[] args) {
        ...
        } //if you put yes it says "I did it!", and if you put no it says "I know you said not to ... but I totally did anyways."
        ...
        while (doIt) {
            iDidIt = true;
            break; //it still says "I did it" for yes, but now for no it will display the "Don't look at me, I didn't do anything!"
        }
